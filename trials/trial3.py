...
st.set_page_config(page_title="File-Bot", layout="wide", )
st.markdown(f"""
            <style>
...
llm = LlamaCpp(model_path="/Users/chochu/Downloads/Models/llama-2-7b-chat.ggmlv3.q8_0.bin")
...
if uploaded_file is not None:
    ...
    # Load pre-generated embeddings using FAISS
    embeddings_file_path = "file-bot/vectorstore/db_faiss"  # Provide the actual file path
